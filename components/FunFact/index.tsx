...
const FunFact = () => {
  const { loading, section } = useSectionStore();
        ...
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-linear-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-linear-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
            ...
            >
              <div className="relative">
                <Image
                  ...
                  alt="Section Logo"
                  className="rounded-full object-cover shadow-2xl border-4 border-white/20 dark:border-gray-700/30"
                />
                ...
                {/* Effet de halo */}
                <div className="absolute inset-0 rounded-full shadow-lg shadow-blue-500/20 dark:shadow-blue-400/10 animate-pulse" />
              </div>
            </motion.div>
          ) : null}
          ...
          {/* <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Cycles</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Programmes</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Cours</p>
            </motion.div>
          </div> */}
        </div>
      </section>
